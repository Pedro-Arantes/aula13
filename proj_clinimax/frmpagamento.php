  ...
  <form method="post">
    <div class="row" >
      ...
      <div class="col-auto">
        ...
        <input type="text" name="modalidade" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
      ...
      <div class="col-auto">
        ...
        <input type="text" name="valor" required class="form-control" id="exampleInputPassword1">
      </div>
      </div>
      <div class="col-auto">
      ...
      <div class="col-auto">
        <label for="exampleInputEmail1" class="form-label">id serviço</label>
