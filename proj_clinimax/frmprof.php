<?php 
  ...
  include('conexao.php');
      ...
      try {
        ...
        $sql = "insert into tblprofissional (nome,graduacao,salario,disponibilidade,especialidade,email) values (:graduacao,:salario,:disponibilidade,:especialidade,:email,:nome)";
...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
  ...
  <form method="post">
    <div class="row" >
      ...
      <div class="col-auto">
        <label for="cpf" class="form-label" name="email">Email</label>
      ...
      <div class="col-auto">
        ...
        <input type="text" name="graduacao" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
      <div id="emailHelp" class="form-text"></div>
      </div>
      <div class="col-auto">
        <label for="exampleInputEmail1" class="form-label">Especialização</label>
        <input type="text" name="especialidade" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
      <div id="emailHelp" class="form-text"></div>
      </div>
      <div class='row'>
      <div class="col-auto">
        <label for="exampleInputEmail1" class="form-label">Sálario</label>
        <input type="text" name="salario" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        <div id="emailHelp" class="form-text"></div>
      </div>
      <div class="col-auto">
        <label for="cpf" class="form-label" >Disponibilidade</label>
        <input type="text" name="disponibilidade" required class="form-control" id="exampleInputPassword1">
      </div>
